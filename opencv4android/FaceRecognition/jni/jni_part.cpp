...
extern "C" {
JNIEXPORT void JNICALL Java_com_tbf_facerecognition_Sample3View_FindFeatures(JNIEnv* env, jobject, jint width, jint height, jbyteArray yuv, jintArray bgra)
{
	try {
...
JNIEXPORT void JNICALL Java_com_tbf_facerecognition_Sample3View_FindFaces(JNIEnv* env, jobject, jstring jImageName,jstring jFileName)
{
	try {
...
JNIEXPORT int JNICALL Java_com_tbf_facerecognition_Sample3View_Find(JNIEnv* env, jobject, jstring jImageName,jstring jFileName,jstring jCsv)
{
	try {
