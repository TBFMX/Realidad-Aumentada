...
public class CppLoader extends Activity implements CvCameraViewListener2 {
    ...
    private static final int	   VIEW_MODE_CARTOON  = 7;
    ...
    private MenuItem			   mItemPreviewCartoon;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mItemPreviewCartoon = menu.add("Cartoon");
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        case VIEW_MODE_FEATURES:
            ...
            break;
        case VIEW_MODE_CARTOON:
        	// input frame has RGBA format
        	mNativeProcessFrame = new FrameProcessor();
        	mNativeProcessFrame.cartoonify(inputFrame.rgba(), mRgba);
        	break;
        case VIEW_MODE_MARKER:
        	...
        	try {
        		...
        		if(frameIsShown == 0){
		        	...
		        	mNativeProcessFrame.augment(inputFrame.rgba(), mRgba, marker);
		        	++frameIsShown;
        		}else{
        			if (frameIsShown >= 60)
        				frameIsShown=0;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        } else if (item == mItemPreviewCartoon){
        	mViewMode = VIEW_MODE_CARTOON;
