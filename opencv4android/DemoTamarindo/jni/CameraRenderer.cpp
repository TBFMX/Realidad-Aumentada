...
JNIEXPORT void JNICALL Java_com_tbf_demotamarindo_Native_initCamera(JNIEnv*, jobject,jint width,jint height)
{
	LOG_INFO("Entering");
...
JNIEXPORT void JNICALL Java_com_tbf_demotamarindo_Native_surfaceChanged(JNIEnv*, jobject,jint width,jint height,jint orien)
{
	LOG("Surface Changed");
...
JNIEXPORT void JNICALL Java_com_tbf_demotamarindo_Native_releaseCamera(JNIEnv*, jobject)
{
	LOG("Camera Released");
	capture.release();
	if(gbIsProcessing == false){
...
JNIEXPORT void JNICALL Java_com_tbf_demotamarindo_Native_renderBackground(JNIEnv*, jobject) {
