...
import com.tbf.glsurface.LibraryClass;
...
public class ImageDetectionFilter implements ARFilter {
    ...
    protected final Mat mReferenceImage;
    ...
    protected boolean mTargetFound = false;
    ...
    public ImageDetectionFilter(final Context context,
        ...
        LibraryClass.initializeAssetManager(mAssetManager);
