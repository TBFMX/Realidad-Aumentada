...
@SuppressLint("SimpleDateFormat") class CartoonifierView extends CartoonifierViewBase {
	...
	protected void showNotificationMessage(Context context, String filename)
    {
        ...
        Notification notification = new Notification(R.drawable.ic_launcher, "Saving to gallery (image " + mNotificationID + ") ...", System.currentTimeMillis());
