package com.tbf.masterdetailexample.dummy;
...
public class DummyContent {
    ...
    static {
        ...
        addItem(new DummyItem("3", "Why Developing Apps for Android id Fun", "Description 3"));
        addItem(new DummyItem("4", "Who win the Fight Between Android and iOS in 2012?", "Description 4"));
